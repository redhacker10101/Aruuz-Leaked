...
codes[String.fromCharCode(0x0651)] = 'تشدید';
    ...
    $.fn.UrduEditor2 = function (options) {
        ...
        $.extend($.fn.UrduEditor2.defaults, options);
        ...
        function setAttributes(el, pt) {
			...
			if($.fn.UrduEditor2.defaults.ToggleControls)
			{
				if($.fn.UrduEditor2.defaults.LineBreak)
				{					
					$(el).after(lineBreak);
				...
				else
				{
					$(el).after(urduBtn);
					$(urduBtn).after(englishBtn);
					if($.fn.UrduEditor2.defaults.VirtualKeyboard)
					{
						$(englishBtn).after(vkBtn);
					}
				}
			}
			else if($.fn.UrduEditor2.defaults.VirtualKeyboard)
			{
				if($.fn.UrduEditor2.defaults.LineBreak)
				{
					$(el).after(lineBreak);
            ...
            with (el.style) {
                fontFamily = $.fn.UrduEditor2.defaults.EditorFont;
                fontSize = $.fn.UrduEditor2.defaults.PointSize;
    ...
    $.fn.UrduEditor2.SetDefaults = function (options) {
        if (null != options) {
    ...
    $.fn.UrduEditor2.ToggleLanguage = function () {
    ...
    $.fn.UrduEditor2.writeKeyboard = function (el) {
