...
namespace Aruuz.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AruuzUser { UserName = Input.UserName, Email = Input.Email, Name = Input.Name, PhotoURL = "/displaypic/default.jpg",BannerURL= "/displaypic/defaultbanner.jpg",TagLine="" };
